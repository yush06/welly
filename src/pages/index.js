                    ...
                    <div className="card-header chat-list-header text-center">
                      ...
                      <div className="dropdown">
                        ...
                        <ul className="dropdown-menu dropdown-menu-right">
                          ...
                          <li className="dropdown-item">
                            <i className="fa fa-users text-primary mr-2" /> Add
                            to close friends
                          </li>
                          <li className="dropdown-item">
                            <i className="fa fa-plus text-primary mr-2" /> Add
                            to group
                          </li>
                          <li className="dropdown-item">
          ...
          <div className="deznav">
            <div className="deznav-scroll">
              ...
              <div className="copyright">
                <p>
                  <strong>Welly Hospital Admin Dashboard</strong> © 2020 All
                  Rights Reserved
                </p>
                  ...
                  <div className="row">
                              ...
                              <div className="d-flex flex-wrap align-items-center px-4 bg-light">
                                <div className="mr-auto d-flex align-items-center py-3">
                                  ...
                                  <div>
                                    ...
                                    <span className="fs-26 text-primary font-w600">
                                      562,084
                                    </span>
                                  </div>
                                </div>
                                <ul className="users pl-3 py-2">
                                  ...
                                  <li>
                                    <img src="assets/images/users/2.png" alt />
                                  </li>
                                  <li>
                                    <img src="assets/images/users/3.png" alt />
                                  </li>
                                  <li>
                                    <img src="assets/images/users/4.png" alt />
                                  </li>
                                  <li>
                                    <img src="assets/images/users/5.png" alt />
                                  </li>
                                </ul>
                              </div>
                      ...
                      <div className="card">
                        ...
                        <div className="card-body pb-0">
                          <ul className="users-sm mb-3">
                            <li>
                              <img src="assets/images/users/6.png" alt />
                            </li>
                            <li>
                              <img src="assets/images/users/7.png" alt />
                            </li>
                            <li>
                              <img src="assets/images/users/8.png" alt />
                            </li>
                            <li>
                              <img src="assets/images/users/9.png" alt />
                            </li>
                            <li>
                              <img src="assets/images/users/10.png" alt />
                            </li>
                          </ul>
                          <div className="d-flex align-items-center">
                            <svg
                    ...
                    <div className="col-xl-12">
                      <div className="card rated-doctors">
                        <div className="card-header border-0 pb-0">
                          <h3 className="fs-20 text-black mb-0 mr-auto">
                            Top Rated Doctors
                          </h3>
                        ...
                        <div className="card-body">
                          <div className="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
                            <div className="d-flex align-items-center mr-auto pr-2">
                              ...
                              />
                              <div>
                                <h4 className="mb-sm-2 mb-1">
                                  <a href="doctor.html" className="text-black">
                                    Dr. Samantha Queque
                                  </a>
                                </h4>
                ...
                <div className="col-xl-6">
                  <div className="row">
                    <div className="col-xl-12">
                      <div className="card appointment-schedule">
                        <div className="card-header pb-0 border-0">
                          ...
                          <div className="dropdown ml-auto">
                            <div
                              className="btn-link p-2 bg-light"
                              data-toggle="dropdown"
                            >
                              <svg
                                width={24}
                        ...
                        <div className="card-body">
                          <div className="row">
                            ...
                            <div
                              className="col-xl-6 col-xxl-12 col-md-6 height415 dz-scroll"
                    ...
                    <div className="col-xl-12">
                      <div className="card">
                        <div className="card-header border-0 pb-0">
                          <h3 className="fs-20 text-black mb-0 mr-2">
                            Revenue Summary
                          </h3>
                          <div className="dropdown mt-sm-0 mt-3">
                            <button
                              type="button"
                              className="btn bg-light text-primary dropdown-toggle"
                              data-toggle="dropdown"
                              aria-expanded="false"
                            >
                              2020
                    ...
                    <div className="col-xl-12">
                      <div className="card patient-activity">
                        ...
                        <div className="card-body pb-0">
                          <div
                            className="table-responsive height720 dz-scroll"
                            id="patient-activity"
                          >
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td>
                                    <div>
                                      ...
                                      <span className="text-primary font-w600 mb-auto">
                                        Allergies &amp; Asthma
                                      </span>
                                    </div>
                                  </td>
                                  <td>
                                    <div>
                                      ...
                                      <span className="text-primary font-w600 mb-2 d-block text-nowrap">
                                        Recovered
                                      </span>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div>
                                      <p className="fs-14 mb-1">Status</p>
                                      <span className="text-danger font-w600 mb-2 text-nowrap d-block">
                                        New Patient
                                      </span>
                                      <p className="mb-0 fs-12">
                                        22/03/2020 12:34 AM
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div>
                                      <p className="fs-14 mb-1">Status</p>
                                      <span className="text-warning font-w600 mb-2 text-nowrap d-block">
                                        In Treatment
                                      </span>
                                      <p className="mb-0 fs-12">
                                        22/03/2020 12:34 AM
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div>
                                      <p className="fs-14 mb-1">Status</p>
                                      <span className="text-warning font-w600 text-nowrap mb-2 d-block">
                                        In Treatment
                                      </span>
                                      <p className="mb-0 fs-12">
                                        22/03/2020 12:34 AM
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div>
                                      <p className="fs-14 mb-1">Status</p>
                                      <span className="text-primary font-w600 mb-2 text-nowrap d-block">
                                        Recovered
                                      </span>
                                      <p className="mb-0 fs-12">
                                        22/03/2020 12:34 AM
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div>
                                      <p className="fs-14 mb-1">Status</p>
                                      <span className="text-warning font-w600 mb-2 d-block text-nowrap">
                                        In Treatment
                                      </span>
                                      <p className="mb-0 fs-12">
                                        22/03/2020 12:34 AM
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div>
                                      <p className="fs-14 mb-1">Status</p>
                                      <span className="text-danger font-w600 mb-2 d-block text-nowrap">
                                        New Patient
                                      </span>
                                      <p className="mb-0 fs-12">
                                        22/03/2020 12:34 AM
                        ...
                        <div className="card-footer text-center border-0">
                          <a href="patient.html" className="btn-link">
                            See More &gt;&gt;
                          </a>
                        </div>
                      </div>
